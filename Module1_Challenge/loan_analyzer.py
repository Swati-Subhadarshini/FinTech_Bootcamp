...
print(f"The total number of loans are: {total_number_loans}")

# What is the total of all loans?
# @TODO: Use the `sum` function to calculate the total of all loans in the list.
# Print the total value of the loans

sum_total_loans = sum(loan_costs)
print(f"The total value of all the loans is: {sum_total_loans}")

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount

average_loan_amount = sum_total_loans/total_number_loans
print(f"The average of loan amount is: {average_loan_amount}")
...
print(f"Remaining months for the Loan: {remaining_months}")
...
print(f"The fair value of loan is: {present_value: .2f}")
...
if present_value >= loan["loan_price"]:
    print("Loan is worth at least the price to buy it")
else:
...
for data in loans:
    if data["loan_price"] <= 500:
        inexpensive_loans.append(data)

# @TODO: Print the `inexpensive_loans` list

print(f"Inexpensive Loan List: {inexpensive_loans}")
...
output_path = Path("inexpensive_Loan_List.csv")
